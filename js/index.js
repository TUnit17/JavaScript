$(document).ready(function() {
  ...
  var Health =
    ...
    player.nerfHealth;
  var Mana =
    100 * player.level + player.buffMana + player.totalMana - player.nerfMana;
  var Dodge =
    5 * player.level + player.buffDodge + player.totalDodge - player.nerfDodge;
  var MagicPow =
    10 * player.level +
    player.buffMagicPow +
    player.totalMagicPow -
    player.nerfMagicPow;
  var Damage =
    10 * player.level +
    player.buffDamage +
  ...
  var StormDMG =
    5 * player.level +
    player.buffStormDMG +
    player.totalStormDMG -
    player.nerfStormDMG;
  var Critical =
    1 + player.buffCritical + player.totalCritical - player.nerfCritical;
  var BloodDMG =
    5 * player.level +
    player.buffBloodDMG +
    player.totalBloodDMG -
    player.nerfBloodDMG;
  var ShadowDMG =
    5 * player.level +
    player.buffShadowDMG +
    player.totalShadowDMG -
    player.nerfShadowDMG;
  var NatureDMG =
    5 * player.level +
    player.buffNatureDMG +
    player.totalNatureDMG -
    player.nerfNatureDMG;
  var HealPow =
    5 * player.level +
    player.buffHealPow +
    player.totalHealPow -
    player.nerfHealPow;
  var Lifesteal =
    player.buffLifesteal + player.totalLifesteal - player.nerfLifesteal;
    ...
    function f() {
      ...
      function fattack() {
        ...
        if (object.manarestore > 0) {
          ...
          $("#rightinfo").prepend(
            "<p>You restore: " + object.manarestore + " Mana!"
          );
        }
        ...
        if (object.healthrestore > 0) {
          ...
          $("#rightinfo").prepend(
            "<p>You restore: " + object.healthrestore + " Health!"
          );
        }

        i++;
        if (i < object.repeat) {
          setTimeout(fattack, object.delay);
        }
      }
    }
    if (
  ...
  function countplayerstats() {
      ...
      if ($.isEmptyObject(player[slotplayernames[d]]) === false) {
        for (var f = 0; f < affixes.length; f++) {
          player["total" + affixes[f][0]] =
            player["total" + affixes[f][0]] +
            player[slotplayernames[d]]["totalstats"][affixes[f][0]];
        }
      }
    } // for loops d f
    ...
    Lifesteal =
      15 * player.level +
      player.buffLifesteal +
      player.totalLifesteal -
      player.nerfLifesteal;
  ...
  function upgradeitem() {
    ...
    if (theitem["upgrade"]["level"] < 5 && player.gold > theitem["level"] * 5) {
      ...
      var upgradestatamount = Math.floor(
        ((upgraderarity + 1) *
          (theitem.level * affixes[randomupgradestat][2])) /
          5
      );
      var maxupgradestatamount = Math.floor(
        (5 * (theitem.level * affixes[randomupgradestat][2])) / 5
      );
      ...
      function countitemstats() {
        for (var i = 0; i < affixes.length; i++) {
          theitem.totalstats[affixes[i][0]] =
            theitem.stats[affixes[i][0]][0] +
            theitem.upgrade.stats[affixes[i][0]][0];
        }
      }
      countitemstats();
    } // if upgrade level
  ...
  function upgradeitemonchar() {
    ...
    if (theitem["upgrade"]["level"] < 5 && player.gold > theitem["level"] * 5) {
      ...
      upgradestatamount = Math.floor(
        ((upgraderarity + 1) *
          (theitem.level * affixes[randomupgradestat][2])) /
          5
      );
      maxupgradestatamount = Math.floor(
        (5 * (theitem.level * affixes[randomupgradestat][2])) / 5
      );
    ...
    function randomitem(slot) {
      for (var i = 0; i < affixnumber; i++) {
        if (i === 0) {
          ...
          generateditem.icon =
            itemslot.toString() + "-" + randompicturenum.toString();
        }
        ...
        var statnumber = Math.floor(
          Math.random() *
            (affixes[randomstat][1] + affixes[randomstat][2] * boss.level)
        );
        var statmax =
          affixes[randomstat][1] + affixes[randomstat][2] * boss.level;
        ...
        generateditem.stats[affixes[randomstat][0]] = [
          statnumber,
          statmax,
          statcolor
        ];
      ...
      for (var f = 1; f < 29; f++) {
        ...
        if (jQuery.isEmptyObject(inventory[invcount])) {
          allclasses =
            "item sprite " + generateditem.icon + " " + generateditem.rarity;
          $(itemidcount).append(
            "<img id='" + itemid + "'class='" + allclasses + "' '></img>"
          );
          f = 50;
  ...
  function startfight() {
    ...
    boss.health =
      boss.level * 500 +
      Math.floor(boss.level / 25) * 10000 +
      Math.floor(boss.level / 100) * 10000;
    boss.damage =
      boss.level * 15 +
      Math.floor(boss.level / 25) * 150 +
      Math.floor(boss.level / 100) * 150;
    ...
    function bossattack() {
      ...
      function attackbasicplayer() {
        ...
        if (bosshitroll > Dodge) {
          $("#leftinfo").prepend(
            "<p>Boss Attacks for: " + bossdamage + " DMG!" + "</p>"
          );
      ...
      function critplayer() {
        ...
        if (bosshitroll > Dodge) {
          $("#leftinfo").prepend(
            "<p>Boss CRITS for: " + bosscritdamage + " DMG!" + "</p>"
          );
      ...
      function castHealPowreduce() {
        ...
        $("#leftinfo").prepend(
          "<p  class='heal' > Boss Casts NERF HealPow!</p>"
        );
      }
      ...
      function castFireDMGreduce() {
        ...
        $("#leftinfo").prepend(
          "<p  class='fire'> Boss Casts NERF FireDMG!</p>"
        );
      }
      ...
      function castStormDMGreduce() {
        ...
        $("#leftinfo").prepend(
          "<p  class='storm'> Boss Casts NERF StormDMG!</p>"
        );
      }
      ...
      function castShadowDMGreduce() {
        ...
        $("#leftinfo").prepend(
          "<p  class='shadow'> Boss Casts NERF ShadowDMG!</p>"
        );
      }
      ...
      function castNatureDMGreduce() {
        ...
        $("#leftinfo").prepend(
          "<p class='nature'> Boss Casts NERF NatureDMG!</p>"
        );
      }
      ...
      function castBloodDMGreduce() {
        ...
        $("#leftinfo").prepend(
          "<p class='danger'> Boss Casts NERF BloodDMG!</p>"
        );
      }
  ...
  $("#summonfaster").click(function() {
    if (player.summoninterval - 10000 > 0) {
      ...
      $("#summons").text(
        "1 spawn per: " + Math.floor(player.summoninterval / 10000) + "min"
      );
    }
  });
  ...
  function sellall() {
    for (var i = 1; i < 29; i++) {
      ...
      if (
        inventory[sellitemid]["value"] != undefined &&
        inventory[sellitemid]["value"] != null
      ) {
  ...
  $("#sell").click(function() {
    function sell() {
      ...
      if (
        inventory[clickeditemid]["value"] != undefined &&
        inventory[clickeditemid]["value"] != null
      ) {
  ...
  $(".slot").click(function() {
    ...
    for (var y = 0; y < affixes.length; y++) {
      ...
      var upgradestatstuff =
        inventory[clickeditemid]["upgrade"]["stats"][affixes[y][0]];
      rarityarr.push(
        inventory[clickeditemid]["upgrade"]["stats"][affixes[y][0]][2]
      );
      ...
      if (y === affixes.length - 1) {
        $("#info").append(
          "<p>Item Level: " + inventory[clickeditemid]["level"] + "</p>"
        );
      }
    }
  ...
  $(".slot1").click(function() {
    ...
    for (var y = 0; y < affixes.length; y++) {
      ...
      var upgradestatstuff =
        player[clickeditemid]["upgrade"]["stats"][affixes[y][0]];
      rarityarr.push(
        player[clickeditemid]["upgrade"]["stats"][affixes[y][0]][2]
      );
      ...
      if (y === affixes.length - 1) {
        $("#info").append(
          "<p>Item Level: " + player[clickeditemid]["level"] + "</p>"
        );
      }
    }
  ...
  function reloadeverything() {
    ...
    for (var f = 1; f < 29; f++) {
      ...
      if (jQuery.isEmptyObject(inventory[invcount1]) === false) {
        var allclasses1 =
          "item sprite " +
          inventory[invcount1]["icon"] +
          " " +
          inventory[invcount1]["rarity"];
        $(itemidcount1).append(
          "<img id='" + itemid1 + "'class='" + allclasses1 + "' '></img>"
        );
      }
    }
    ...
    for (var x = 0; x < slotplayernames.length; x++) {
      ...
      if (jQuery.isEmptyObject(player[itemslot1]) === false) {
        var allclasses1 =
          "item sprite " +
          player[itemslot1]["icon"] +
          " " +
          player[itemslot1]["rarity"];
        $(itemid1).append(
          "<img id='" + newid1 + "'class='" + allclasses1 + "' '></img>"
        );
      }
    }
  }
